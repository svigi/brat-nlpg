    ...
    var AnnotatorUI = function(dispatcher, svg) {
      ...
      var onDblClick = function(evt) {
        ...
        // if not an arc, then do we edit a span?
          ...
          addUserDefinedSpanTypesToDivInner(editedSpan.from, editedSpan.to);
...
//                        true, true);
        ...
        if (arcDragOrigin) {
          ...
          if (chunkIndexFrom !== undefined && chunkIndexTo !== undefined) {
            ...
            if (crossSentence) {
              ...
              addUserDefinedSpanTypesToDivInner(selectedFrom, selectedTo);
              //alert('fill után')
      ...
      var addUserDefinedSpanTypesToDivInner = function(fromPos, toPos) {
      ...
      var spanFormSubmit = function(evt, typeRadio) {
		...
		{
			//alert("other checked");
	        var otherentityvalue = $('#span_otherentity').val();
		...
		else
		{
            ...
            if (checkedBoxes == 0)
            {
	            alert("Please select the entity name!");
	            return false;
			}
			else
			{
	        	$.extend(spanOptions, { type: type });
	        } 
